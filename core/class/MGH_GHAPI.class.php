...
class MGH_GHAPI {
   ...
   public static function getCOMMIT_infos($owner, $repo, $path, $branch, $user, $token){
      ...
      $data['last_commit_date']=MGH_GHAPI::gvfaKR($dataJson[0],array('commit','author','date'));
   ...
   public static function getPR_infos($owner, $repo, $branch, $user, $token){
      ...
      $data['pr_open_date']=MGH_GHAPI::gvfaKR($dataJson[0],array('created_at'));
      ...
      $data['pr_closed_date']=MGH_GHAPI::gvfaKR($dataJson[0],array('closed_at'));
   ...
   public static function getFORK_infos($owner, $repo, $branch, $user, $token){
      ...
      $data['fork_date']=MGH_GHAPI::gvfaKR($dataJson[0],array('created_at'));
